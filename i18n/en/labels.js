...
export const bleedingPrediction = {
  ...
  predictionStartedXDaysLeft: numberOfDays =>
    `Your period is likely to start today or during the next ${numberOfDays} days.`,
...
export const home = {
  ...
  cycleDayNotEnoughInfo:
    "We don't have enough information to know what your current cycle day is.",
  unknown: '?',
...
export const fertilityStatus = {
  ...
  preOvuText:
    "With NFP rules, you may assume 5 days of infertility at the beginning of your cycle, provided you don't observe any fertile mucus or cervix values.",
  periOvuText:
    'We have not been able to detect both a temperature shift and mucus or cervix shift.',
  postOvuText: tempRule => {
    return (
      'We have detected a temperature shift (' +

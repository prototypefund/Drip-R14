...
export default {
  ...
  menuItems: {
    ...
    nfpSettings: {
      name: 'Fertility settings',
      text: 'define how you want to use fertility tracking',
    },
    dataManagement: {
      name: 'Data',
...
2. Delete all existing cycle days and import cycle days from file.`,
  ...
  fertilityTrack: {
    title: 'Enable fertility features',
    fertilityEnable:
      'This setting enables fertility features in the app. Disabling will hide the non period tracking symptoms.',
  },
  useCervix: {

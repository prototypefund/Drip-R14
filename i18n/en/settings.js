...
2. Delete all existing cycle days and import cycle days from file.`,
  ...
  useCervix: {
    ...
    cervixModeOn:
      'Cervix values are being used for symptothermal fertility detection. You can switch here to use mucus values for symptothermal fertility detection',
    cervixModeOff:
      'By default, mucus values are being used for symptothermal fertility detection. You can switch here to use cervix values for symptothermal fertility detection'
  },
  passwordSettings: {
    title: 'App password',
    explainerDisabled:
...
You can contact us by bloodyhealth@mailbox.org.`
  ...
  preOvu: {
    ...
    note: `drip applies NFP's rules for calculating infertile days at the start of the cycle (see the ${
      links.wiki.url
    } for more info). However, drip does not currently apply the so called 20-day-rule, which determines infertile days at the cycle start from past cycle lengths in case no past symptothermal info is available.`
  },
  credits: {
    title: 'Credits',
    note:
      'Thanks and lots of <3 to all of our contributors as well as Susanne Umscheid for the wonderful design, and Paula Härtel for the symptom icons.'
  }
}
